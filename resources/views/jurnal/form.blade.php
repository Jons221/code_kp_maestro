										...
										<div class="row">
											<div class="col-6">
												<div class="form-group">
													...
													<input class="form-control @error('transaction_no') is-invalid @enderror" id="transaction_no" name="transaction_no" value="{{ isset($pc) ? $pc : $jurnal['transaction_no'] }}" autocomplete="off" readonly>
