          ...
          <div class="scroll-sidebar" data-sidebarbg="skin6">
              ...
              <nav class="sidebar-nav">
                  ...
                  <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('home')}}"
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link" href="{{route('partners.index')}}"
                              aria-expanded="false"><i data-feather="user" class="feather-icon"></i><span
                                  class="hide-menu">Partner
                              </span></a>
                      </li>
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link" href="{{route('invoices.index')}}"
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link" href="{{route('penerimaan-kas.index')}}"
                        aria-expanded="false"><i data-feather="bookmark" class="feather-icon"></i><span
                            class="hide-menu">Laporan Penerimaan kas
                              </span></a>
                      </li>
                      <li class="sidebar-item"> <a class="sidebar-link" href="{{route('pembelian.index')}}"
                        aria-expanded="false"><i data-feather="bookmark" class="feather-icon"></i><span
                            class="hide-menu">Laporan Pembelian
                              </span></a>
                      </li>
                      <li class="sidebar-item"> <a class="sidebar-link" href="{{route('pengeluaran-kas.index')}}"
                        aria-expanded="false"><i data-feather="bookmark" class="feather-icon"></i><span
