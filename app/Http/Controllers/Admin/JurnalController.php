...
class JurnalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::table('jurnal_lines')->insert($jurnalDetail);
            DB::commit();
    ...
    public function update(Request $request, Jurnal $jurnal)
    {
      ...
      try {
          ...
          $invoice = JurnalDetail::select('invoice_id')->where('jurnal_id', $jurnal->id)->first();
          $payment = JurnalDetail::select('payment_id')->where('jurnal_id', $jurnal->id)->first();
